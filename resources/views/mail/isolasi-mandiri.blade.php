...
<body>
    <div class="container">
        ...
        <div class="row title-container">
            <h1>SURAT KETERANGAN ISOLASI MANDIRI</h1>
        </div>
        ...
        <div class="row desc-container">
            <div class=" col">No. Rk : {{ $rekam_medis_id }}</div>
            <div class=" col">Nama : Yofan</div>
            <div class=" col">Umur : 21</div>
        </div>
        <br>
        <div class="row desc-container">
            <div class=" col">Diagnosa : {{ $diagnosa }}</div>
            <div class=" col">Jenis Kelamin : L;aki - Laki</div>
            <div class=" col">Alamat : Banyuwangi</div>
        </div>
        <br>
        <div class="row desc-container">
            <div class=" col">Keterangan : Silahkan melakukan isolasi mandiri 14 hari kedepan</div>
        </div>
